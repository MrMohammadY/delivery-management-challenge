...
class RewardDeduction(BaseModel):
    ...
    price = models.DecimalField(max_digits=9, verbose_name=_('price'))
...
class DailySalary(models.Model):
    ...
    daily_balance = models.DecimalField(max_digits=9, verbose_name=_('price'))
...
class WeeklySalary(models.Model):
    ...
    weekly_balance = models.DecimalField(max_digits=9, verbose_name=_('price'))
